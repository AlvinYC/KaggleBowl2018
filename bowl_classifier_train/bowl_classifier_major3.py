...
def validing_model(args,valid_loader,kth=None,labelname=None):
    ...
    fn.write("uid\tground_truth\tprediected\tcorrect\tHitology\tFluorescence\tBrightfield\tconfidence\n")
...
if __name__ == '__main__':
    ...
    if args.mode == 'train':
        ...
        dataset_train = prepare_dataset(args,category=None)
        ...
        if re.search('\d+|loocv',args.cv):
            ...
            for kth in range(maxK):
                ...
                training_model(args, train_loader, kth=kth, labelname=dataset_train.majorlabels)
                for epoch in epoch_checkpoint:
                    ...
                    validing_model(args, valid_loader, kth=kth, labelname=dataset_train.majorlabels)
        ...
        if args.cv == 'no':
            ...
            training_model(args, train_loader, kth=None, labelname=dataset_train.majorlabels)
    ...
    if args.mode == 'valid':
        ...
        dataset_valid      = prepare_dataset(args,category=None)
